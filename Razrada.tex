...
Analiza koja omogućava optimizaciju lenjih  funkcionalnih programa identifikujući parametre koji mogu biti prosleđeni po vrednosti tako da se izbegne potreba za pravljenjem zatvorsenja (eng. closure) i otvara se mogućnost paralelne evaluacije. 
